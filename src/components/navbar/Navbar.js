...
const Navbar = () => {
  ...
  return (
    <>
        ...
        <nav class="flex justify-between items-center relative w-full text-primaryText font-fontParagraph z-[12]">
         {/* Logo */}
          <div
      ...
      <div className="absolute top-10 right-10 cursor-pointer z-[51]" onClick={toggleMenu} style={{ opacity: menuVisible ? 1 : 0 }}>
        <svg
          stroke="currentColor"
          fill="currentColor"
          strokeWidth="0"
      ...
      {/* Main Navigation Menu */}
       <div
         className={`fixed top-0 w-full h-full bg-mainBg z-50 flex items-center justify-center transition-all duration-300 transform ${
        ...
        >
          <nav className="flex flex-col items-center gap-4 justify-center relative w-full h-full text-primaryText">
            <ol className="flex justify-between items-center p-0 m-0 list-none flex-col">
              <li className="p-[10px] text-lg flex flex-col items-center font-mono tracking-wide" style={{ opacity: 1, transform: 'none' }}>
                <span className="text-themeBlue text-base mr-1">01.</span>
                <a href="/#" className="hover:text-themeBlue transition-all duration-200">Home0</a>
              </li>
              <li className="p-[10px] text-lg flex flex-col items-center font-mono tracking-wide" style={{ opacity: 1, transform: 'none' }}>
                <span className="text-themeBlue text-base mr-1">02.</span>
                <a href="/#about" className="hover:text-themeBlue transition-all duration-200">About</a>
              </li>
              <li className="p-[10px] text-lg flex flex-col items-center font-mono tracking-wide" style={{ opacity: 1, transform: 'none' }}>
                <span className="text-themeBlue text-base mr-1">03.</span>
                <a href="/#projects" className="hover:text-themeBlue transition-all duration-200">Projects</a>
              </li>
              <li className="p-[10px] text-lg flex flex-col items-center font-mono tracking-wide" style={{ opacity: 1, transform: 'none' }}>
                <span className="text-themeBlue text-base mr-1">04.</span>
                <a href="/#contact" className="hover:text-themeBlue transition-all duration-200">Contact</a>
              </li>
            </ol>

            <div className="transition-all ease-in-out duration-300 hover:-translate-x-1 hover:-translate-y-1 mt-[15px]" style={{ opacity: 1 }}>
              <a
                href="https://drive.google.com/file/d/11nsro2l3Z09Cdg36RCH_BxD11RTFGoH7/view"
                className="font-mono text-themeBlue bg-transparent border border-themeBlue rounded-[4px] py-[10px] px-4 text-[14px] transition-all ease-in-out duration-300 hover:shadow-buttonShadow"
                target="_blank"
