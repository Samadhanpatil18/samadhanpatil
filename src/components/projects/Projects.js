                ...
                <li className="relative grid gap-[10px] grid-cols-12 items-center mb-[70px] md:mb-[100px] transition-all duration-200 shadow-aboutShadow md:shadow-none">
                    ...
                    >
                        ...
                        <h3 className="text-primaryText font-bold leading-[1.1] text-sectionHeading transition-all duration-200 hover:text-themeBlue font-fontHeading md:mb-[20px]">
                            <a
                                href="https://foodeasy-frontend.onrender.com/"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                <b>FoodEasy</b> <br></br>Food Delivery App
                            </a>
                        </h3>
                        <div class="shadow-none md:shadow-aboutShadow transition-all duration-200 relative z-[2] py-[20px] md:p-[25px] rounded text-secondaryText text-base bg-transparent md:bg-[#112240] font-fontParagraph md:hover:shadow-bigShadow text-justify flex items-center justify-center">
                            <p>
                                Built a full-stack Food Ordering App with secure Stripe API for smooth payment processing.Designed dynamic user interfaces with React.js and implemented efficient RESTful APIs using Express.js.Optimized MongoDB database to handle over 10,000 daily transactions with high performance.Developed an admin panel and user dashboard, boosting retention by 30% through an Material-UIDelivered a robust solution with 99.9% uptime,adhering to industry best practices in full-stack development.
                        ...
                        <div className="flex items-center relative mt-[10px] ml-[10px] md:justify-end md:ml-0 md:mr-[10px] text-primaryText text-[22px]">
                            <a
                                href="https://github.com/Samadhanpatil18/FoodEasy"
